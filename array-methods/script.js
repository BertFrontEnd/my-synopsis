...
let arr9 = [1, 2, 3, 4, 5];
console.log(arr9);
let newArr9 = arr9.concat(6, 7, 8, 9, 'Миша', 'Даша', 'Дима', 'Саша', 'Катя',  [10, 11, 12, 13], {name: 'Sergey'}); // В качестве аргумента можно указать числа, строки, массивы, объекты
...
let newArr10 = arr10.map((item, index, array) => item += ` - это имя из ${item.length} букв и это элемент массива под номером ${index} из массива: [${array}]`); // Запись функции на ES6. В качестве аргумента можно указать: item - элемент исходного МАССИВА, index - индекс элемента исходного МАССИВА и array - сам исходный МАССИВ
...
console.log('06. Вычисление одного значения на основе всего МАССИВА "reduce" и "reduceRight"');
let arr12 = [1, 2, 3, 4, 5];
console.log(arr12);
...
console.log('"reduceRight" работает аналогично "reduce", но проходит по МАССИВУ справа налево');
console.log('');
...
let newArr13 = arr13.forEach((item, index, array) => console.log(`${item} - это элемент массива [${array}] под номером "${index}"`)); // Запись функции на ES6. В качестве аргументов используется ФУНКЦИЯ. В качестве аргументов ФУНКЦИИ можно указать: item - элемент исходного МАССИВА, index - индекс элемента исходного МАССИВА и array - сам исходный МАССИВВ
...
console.log('"lastIndexOf" работает аналогично "indexOf", но проходит по МАССИВУ справа налево');
console.log('');
...
console.log('"findIndex" работает аналогично "find", но возвращает вместо самого ЭЛЕМЕНТА его ИНДЕКС');
console.log('');
